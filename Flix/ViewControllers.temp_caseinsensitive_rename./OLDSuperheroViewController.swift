...
class SuperheroViewController: UIViewController, UICollectionViewDataSource, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        //display the activityIndicator for desired seconds when user refresh the screen
    ...
    // MARK: create cell and insert poster image using url and poster_path
    ...
    // MARK: Refresh the network and fetch the movies
    func refreshScreen(){
        refreshControl = UIRefreshControl()
    ...
    // MARK: Refresh the page and fetch movies
    @objc func didPullToRefresh(_ refreshControl: UIRefreshControl) {
        fetchMovies()
    }
    
    // MARK: SearchBar - Update filteredMovie based on the text in the Search Box
    ...
    // MARK: Perform segue to connect with PosterDetailViewController
